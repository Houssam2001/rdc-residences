...
function WireframeHouse({ mouseX, mouseY }: { mouseX: number; mouseY: number }) {
  ...
  // Build house geometry from edges
  ...
  return (
    <group ref={groupRef}>
      <lineSegments>
        ...
        <lineBasicMaterial color="#00ff88" transparent opacity={0.5} linewidth={1} />
      </lineSegments>
    </group>
  );
}
  ...
  return (
    <group ref={groupRef}>
      <lineSegments>
        ...
        <lineBasicMaterial color="#005433" transparent opacity={0.15} />
      </lineSegments>
    </group>
  );
}
...
/* ─── Measurement Lines (Architect annotation) ─── */
  ...
  return (
    <group ref={groupRef}>
      <lineSegments>
        ...
        <lineBasicMaterial color="#005433" transparent opacity={0.3} />
      </lineSegments>
    </group>
  );
}
...
/* ─── Main Scene ─── */
export default function ArchitectureScene({ mouseX = 0, mouseY = 0 }: { mouseX?: number; mouseY?: number }) {
  return (
